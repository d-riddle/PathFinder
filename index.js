onload = function () {
    ...
    var cities = ['Bangalore', 'Bhubneswar', 'Delhi', 'Hyderabad', 'Kolkata', 'Chennai', 'Agra', 'Ranchi', 'Coimbatore', 'Puducherry', 'Jaipur', 'Kerela'];
    ...
    function createGraphData() {
        V = Math.floor(Math.random() * 8) + 5; // Ensures V is between 5 and 15
        var nodes = [];
        for (var i = 1; i <= V; i++) {
        ...
        while (i <= V / 2) {
            ...
            if (num1 !== num2) {
                ...
                // If flag == 0, you can add train as well as flight between vertices.
                // If flag == 1, you can only add flight between them.
                if (flag <= 1) {
                    if (flag === 0 && i < V / 4) {
                        // Adding a train
                        edges.push({
